pub mod tests {
    ...
    use crate::tests::{
        ...
        utils::{
            ...
            sender_calculate_partial_secret, verify_and_calculate_signatures, receiver_calculate_shared_secret
        },
    };
    ...
    fn process_test_case(test_case: TestData) {
        ...
        for receivingtest in test_case.receiving {
            ...
            let outpoints_hash = hash_outpoints(&outpoints).unwrap();
            let tweak_data = calculate_tweak_data_for_recipient(&input_pub_keys, &outpoints_hash);
